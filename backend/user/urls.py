...
from .views import login_view, register_view, logout_view, get_user_by_id, session_view, save_bio, get_user_by_username
...
urlpatterns = [
    ...
    path("users/<str:username>/", get_user_by_username, name="get_user_username"),
